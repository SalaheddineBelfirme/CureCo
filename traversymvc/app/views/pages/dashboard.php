            ...
            <div class="card">
              ...
              foreach ($data['product'] as $pr) { ?>
                            <tr>
                                ...
                                <td scope="row"> <img style="width: 100px ;height: 100px;" id="imgp"
                                        src="../public/imgg/<?php echo $pr->image ?>" alt=""></td>
                                <td scope="row" style=" height: 100px; " class="d-flex align-items-center ">

                                    <form
                                        action="<?php echo URLROOT ?>/product/deleteproudct/<?php echo $pr->id_prodct  ?>"
                                        method="post">

                                        <button style="margin-left:10px" class="btn btn-danger"><i
                                                class="fa fa-trash"></i></button>
                                    </form>


                                    <a id="updateprodact" style="margin-left: 10px;" class="btn btn-success"
                                        onclick="editProduct(<?php echo $pr->id_prodct ?>)" data-bs-toggle="modal"
                                        data-bs-target="#crupdate" data-bs-whatever="@mdo"><i
              ...
              foreach ($data['categorie'] as $categorie) { ?>
                            <tr>
                                ...
                                <td scope="row" style=" height: 100px; " class="d-flex align-items-center ">
                                    ...
                                    <form
                                        action="<?php echo URLROOT ?>/categorie/deletecategorie/<?php echo $categorie->id_c ?>"
                                        method="post">
                                        <button style="margin-left: 10px;" class="btn btn-danger"><i
                                                class="fa fa-trash"></i></button>
                                    </form>
                                    <form
                                        action="<?php echo URLROOT ?>/categorie/updatecategorie/<?php echo $categorie->id_c ?>"
                                        method="post">
                                        <button id="updatecate" style="margin-left: 10px;" class="btn btn-success"><i
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="modleadd" action="<?php echo URLROOT ?>/product/addprudct" class="d-flex flex-column gap-3"
            ...
            <div class="modal-footer">
                ...
                <button id="btnSubAdd" class="btn bg-primary text-light  " name="submitadd"
...
<div class="modal fade" id="crupdate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formupdate" action="<?php echo URLROOT ?>/product/aupdteproduct"
                    class="d-flex flex-column gap-3" enctype="multipart/form-data" method="POST">
                    <input type="hidden" name="id" id="id">
                    <input id="namep" name="name" type="text" class="form-control" placeholder="name"
                        aria-label="Username" aria-describedby="basic-addon1" required>
                    <span id="namepER"></span>
                    <input id="prixp" name="prix" type="text" class="form-control" placeholder="prix"
                        aria-label="Recipient's username" aria-describedby="basic-addon2" required>
            ...
            <div class="modal-footer">
                ...
                <button id="btnSubAdd" class="btn bg-primary text-light  " onclick="chekvalidte()" name="submitupdate"
                    type="submit">Submit</button>
...
$.ajax({
  ...
  type: "POST",
  url: "<?= URLROOT.'/categorie/getcategorie/'?>",   
  data: "{empid: empid}",
  dataType: "json",
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="<?php echo URLROOT ?>/categorie/add_categorie"
                    style="width: 50%; margin: auto; margin-top: 10%;" class="was-validated">

                    <div class="mb-3">
                        <input type="text" placeholder="Name" name="namecategorie" class="form-control"
                            aria-label="file example" required>
                    </div>
                    <div class="mb-3">
                        <input type="text" placeholder="point_depart" name="pays" class="form-control"
                            aria-label="file example" required>
                    </div>
