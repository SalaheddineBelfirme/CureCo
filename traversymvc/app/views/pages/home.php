      ...
      <div class="col-12 mt-5 px-5">
        ...
        <?php for($i=0;$i<count($data['proudct']);$i++){?>  
            ...
            <div class="card-body text-start">
              ...
              <img  style=" height: 200px; " src="<?= URLROOT ?>/imgg/<?php echo $data['proudct'][$i]->image ?>" class="card-img-top img-thumbnail"
                alt="..." />
...
<div class="container shadow bg-light w-75 pt-0"> 
       ...
       <div  class="row text-center mt-5">
           <h6 id="h1contact" style="color:#65ff5a !important;" class=" text-center text-success  px-3">CONTACT US</h6>
               ...
               <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                   <div class="carousel-inner">
                     <div class="carousel-item active">
                       <img style="height: 449px;" src="<?php echo URLROOT ?>/public/imgg/c1rb.png" class="d-block w-100" alt="...">
                     </div>
                     <div class="carousel-item">
                       <img style="height: 449px;" src="<?php echo URLROOT ?>/public/imgg/c3rb.png" class="d-block w-100" alt="...">
                     </div>
                   </div>
