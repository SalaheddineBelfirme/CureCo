...
<div style="background: url(<?= URLROOT ?>/imgg/bgg.jpg)" class="jumbotron bg-cover text-white">
    <div class="container py-5 text-center">
        ...
        <a href="<?php echo URLROOT ?>/Pages/dashboard" style="background-color:#65ff5a" role="button"
            class="btn btn-success px-5">dashboard</a>
    </div>
</div>
        ...
        <section class="prices">
            <div class="container py-5 bg-light">
                <div class="row d-flex flex-column align-items-center text-center">
                            ...
                            <div class="card shadow-lg p-3 mb-5 bg-white rounded" style="width: 22rem">
                                <div class="card-body text-start">
                                    ...
                                    <img style=" height: 200px; "
                                        src="<?= URLROOT ?>/imgg/<?php echo $data['proudct'][$i]->image ?>"
                                    ...
                                    <p>
                                        <a href="" class="card-text text-muted" style="text-decoration: none">View
                                            Details</a>
                                    </p>
                                </div>
                            </div>
                    ...
                    <a href="<?php echo URLROOT ?>/Pages/dashboard" id="btn"
                ...
                <div class="row d-flex justify-content-evenly align-items-center">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="counter">
                            ...
                            <h3><?php echo $data['category'][$i]->name_categorie ?></h3>
            ...
            <div class="container shadow bg-light w-75 pt-0">
                ...
                <div class="row text-center mt-5">
                    <h6 id="h1contact" style="color:#65ff5a !important;" class=" text-center text-success  px-3">CONTACT
                        US</h6>
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img style="height: 449px;" src="<?php echo URLROOT ?>/public/imgg/c1rb.png"
                                        class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img style="height: 449px;" src="<?php echo URLROOT ?>/public/imgg/c3rb.png"
                                        class="d-block w-100" alt="...">
                                </div>
                            </div>
                ...
                <div class="col  text-center ">
                    <button style="background-color: #65ff5a" class="btn btn  mb-3 ">Send</button>
                </div>
